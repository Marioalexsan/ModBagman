...
public static class Game1Extension
{
    ...
    public static void EXT_AddQuest(this Game1 game, QuestCodex.QuestID questID)
    {
        ...
        {
            Program.Logger.LogError("Couldn't add quest {quest}: It's neither a mod nor a vanila quest.", questID);
        }
    ...
    public static void EXT_ForgetQuest(this Game1 game, QuestCodex.QuestID questID)
    {
        ...
        {
            Program.Logger.LogError("Couldn't forget quest {questID}: It's neither a mod nor a vanila quest.", questID);
        }
